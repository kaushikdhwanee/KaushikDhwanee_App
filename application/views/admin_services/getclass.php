				...
				<!-- Modal content-->
					<div class="modal-content">
						<div class="modal-header view-popup-box-header">
							...
							<h4 class="modal-title"><?=$class_info['class_name']?></h4>
						</div>
						<div class="modal-body">
							<div class="popup-class">
							<p class="popup-txt">
									<a href="<?=base_url("admin_services/addclass/".$class_info['id'])?>" id="popup-txt">
										<i class="fa fa-pencil" style="color:rgb(204,204,204)"></i>&nbsp;&nbsp;Edit
									</a>
								</p>
								<p class="popup-txt">
									<a href="<?=base_url("admin_services/updateclassstatus/".$class_info['id']."/".$class_info['status'])?>" id="popup-txt">
