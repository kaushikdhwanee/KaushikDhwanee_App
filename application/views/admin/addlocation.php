					...
					<div class="col-lg-12">
						...
						<div class="panel panel-flat">
							...
							<div class="panel-heading">
								...
								<h5 class="panel-title">Add Summercamp Locations</h5>
							...
							<form method="post" id="branch" enctype="multipart/form-data" action="<?=base_url("admin/insertlocation")?>">
							...
							<div class="col-md-12 product">
							  ...
							  <div class="form-group  col-md-4">
								...
								<div class="form-group  col-md-4">
								 ...
								 <input class="form-control" name="time" value="<?=@$branch_info['time']?>" placeholder="Enter Days and Time"                                                             type="text">
