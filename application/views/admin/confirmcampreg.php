...
<p>
	You have been successfully Registered for <span style="color:red">Summer Camp</span> starting from <span style="color:red"><?=$start_date?></span>
					</p>
					<p>Details of Registration has been sent to registered email.</p>
				...
				<p>Please contact below number for any queries</p>
