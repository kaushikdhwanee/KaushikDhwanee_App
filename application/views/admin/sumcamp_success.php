        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="page-title">
					...
					<p> Please click <a href="<?=base_url("summercamp/summercamp_insert")?>" style="color:white;"><button type="button" class="btn btn-primary">OK</button></a> for successful enrollment</p>
