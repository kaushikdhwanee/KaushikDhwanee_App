...
Serilingampally, Hyderabad-19 </br>
                             ...
                             <td style="width:33%" class="title">
                                <img src="<?=base_url()."/assets/admin/images/"?>logo1.png" style="width:100%; max-width:200px;">
                            </td>
				...
				<table>
				  <tr>
				   <td style="width:40%">
				    ...
				    <td style="width:60%">
				     <h6 style="font-size:16px; margin:0px; line-height:20px; text-align:center; border-bottom:1px dotted #ccc; "> <?=$payments['name']."(".$payments['mobile'].")" ?> </h6> 
				   </td>
				  </tr>
				   <tr>
			  ...
			  <td colspan="2">
			     <table class="table-border1" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td><?=$value['name']?></td>
                    <td style="height:50px;"><?=(!empty($value['invoice_month']) && !empty($value['invoice_year'])?$month[$value['invoice_month']]."'".date("y",strtotime($value['invoice_year']))."-".$value['class_name']:"Registration Amount")?></td>
                    <td><?=$value['amount']?>/-</td>
                    <!-- <td>---</td> -->
                    </tr>
                    <?php 
					...
					<tr>
                    <td colspan="3"style="text-align:right"><h6 style="margin:0px 10px; padding:0px; font-size:16px; ">Discount</h6></td>
                    ...
                    ?>
					 <tr>
                    <td colspan="2" style="text-align:right"><h6 style="margin:0px 10px; padding:0px; font-size:16px; ">Total</h6></td>
