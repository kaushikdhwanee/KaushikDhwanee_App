    ...
    min-height: .01%;
       ...
       ?>             
                     <tr id="main">
                        ...
                        <td ><div class="text"><?=$value['name']?></div></td>
						...
						<td>  <div class="text-muted text-size-small">
                           	<input type="text" class="form-control" id="session_week" name="session_week" value="<?=$value['session_per_week']?>"placeholder="" >
                            <input type="hidden" class="form-control" id="enroll_id" name="enroll_id" value="<?=$value['id']?>"placeholder="" >
                           </div></td>
                           ...
                           <td>  <div class="text-muted text-size-small">
                           	<input type="text" class="form-control" id="total_session" name="total_session" value="<?=$value['total_sessions']?>"placeholder=""  >
                           ...
                           <td class="hidden"><div class="text-muted text-size-small">
							<div class="input-group">
										...
										<input type="text" class="form-control" id="hiddendate" name="startdate" value="<?=$value['due_date']?>"placeholder="" >
						</div>
						</div> 
						...
						<td>  <div class="text-muted text-size-small col-md-2">
							<div class="input-group">
										<span class="input-group-addon"><i class="icon-calendar"></i></span>
										<input type="date" class="form-control" id="start_date" name="start_date" value= "" placeholder="" class="start_date">
						</div>
						</div> 
						...
						<td>  <div class="text-muted text-size-small">
							<div class="input-group">
										<span class="input-group-addon"><i class="icon-calendar"></i></span>
										<input type="date" class="form-control" name="end_date" id="end_date" value=""placeholder="">
						</div>
						</div> 

						</td>
                       <td>
					  <div class="text-muted text-size-small" id="final_amount"><i class="fa fa-inr" aria-hidden="true"></i> <?=$value['course_fee']?></div> 
					   ...
					   <div class="text-muted text-size-small" id="balance_amount"><i class="fa fa-inr" aria-hidden="true"></i> <?=round($value['balance_amount'],2);?></div> 
...
<script>
		   	...
		   	$.ajax({
			   		...
			   		success: function(message){
                         ...
                         var plan = $("#plan_id").val();
                            ...
                            var str1 = plan.split("|");
                           session_taken=$("#session_taken").text();
                           total_session=$("#total_session").val();
                         if(session_taken > total_session){
    ...
    $("#attendence_date").val(session_enddate);
	...
	$(document).on("click",".check",function(){
	 ...
	 $(document).on("change","#plan_id",function(){
		 ...
		 $('#abcd'+data).text(amount);
		    ...
		    $(this).closest("tr.main").find('#total_session').val(sessions_per_week);
