      ...
      <div class="col-lg-12">
     	<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Summer Camp Registration</h5>
								
							</div>
							<form method="post" action="<?=base_url("admin/insertcampstudent")?>" id="student" enctype="multipart/form-data" >
							  <div class="col-md-12">
                              	<div class="col-md-12">
							    ...
							    <!-- <div class="form-group col-md-12">
								 ...
								 <div class="form-group col-md-12">
									<label class="control-label col-md-4"><p class="sib-dis">Plan <i class="fa fa-asterisk text-danger"></i></p></label>
									 ...
									 <div class="form-group col-md-4" style="display:none" id="package">
									 <select class="selectpicker" id="activity" name="activity[]" multiple multiple data-max-options="3" data-style="btn-info">
								...
								<div class="col-md-4">
								  ...
								  <div class="form-group col-md-12">
									<label class="control-label col-md-4"><p class="sib-dis">Avail Transport?</p></label>
									 <div class="col-md-4">
									 <select data-placeholder="Transport" class="select form-control" id="transport" name="transport">
